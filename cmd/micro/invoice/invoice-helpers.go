...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, data interface{}) error {
	maxBytes := 1048576 //I`m not gonna handle anything bigger than 1 megabyte = 1048576 bytes
...
func (app *application) badRequest(w http.ResponseWriter, r *http.Request, err error) error {
	...
	payload.Error = true // there is error
...
//CreateDirIfNotExist checks and creates non existing director
